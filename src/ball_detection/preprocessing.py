...
def frame_preprocessing(frame: cv2.typing.MatLike, 
    ...
    #median_frame = cv2.bilateralFilter(median_frame, 15, 100, 75)
...
def video_preprocessing(video_path: os.PathLike[str],
    ...
    modified_polygon = compute_modified_polygon(lane_points, 30, 20)
    ...
    print(f"Ball detection: preprocessed video saved {save_path}")
