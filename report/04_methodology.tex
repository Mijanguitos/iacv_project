...
An alternative standard structural representation, lightness, was also tested to observe if averaging the maximum and minimum color components provided better separability for the lane textures. The lightness channel from the HLS color space is mathematically defined as:
...
To further improve robustness against illumination changes, Principal Component Analysis (PCA) was applied. By projecting the RGB channels into a lower-dimensional space and retaining only the first principal component, this method aims to isolate the dominant structural features of the lane regardless of specific lighting conditions.
