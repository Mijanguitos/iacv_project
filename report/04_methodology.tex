...
As a baseline, the standard grayscale conversion was evaluated conversion \cite{opencv_color_conversion,gonzalez2008digital}  . This transformation computes a weighted combination of the RGB channels according to perceptual luminance:
...
Additionally, a color transformation inspired by lane detection approaches in the autonomous driving domain was explored \cite{WU20142756}. Specifically, the R+G-B transformation (commonly referred to as rgminusb) was considered:
\begin{equation}
I = R + G - B
\end{equation}
