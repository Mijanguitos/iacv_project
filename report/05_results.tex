...
\begin{figure}[htbp]
    \centering
    % You can use the subcaption package to arrange your 3 images side-by-side or in a grid, 
    % or simply stack them vertically. Here is a single image placeholder as an example.
    % \includegraphics[width=0.8\textwidth]{images/Screenshot 2026-06-04 004850.png}
    \caption{Three-dimensional spatial reconstruction of the lane and ball trajectory. The 2D homographic data is mapped into a physical coordinate space, rendering the lane's true dimensions, the origin point, and a volumetric model of the ball following the calculated trajectory path.}
