...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{figures/Politecnico_Di_Milano/logo_polimi_scritta.eps}
...
\begin{figure}[H]
    ...
    \subfloat[One PoliMi logo.\label{fig:polimi_logo1}]{
        \includegraphics[scale=0.5]{figures/Politecnico_Di_Milano/logo_polimi_scritta.eps}
    }
    \quad
    \subfloat[Another one PoliMi logo.\label{fig:polimi_logo2}]{
        \includegraphics[scale=0.5]{figures/Politecnico_Di_Milano/logo_polimi_scritta2.eps}
    }
    \caption[]{Caption of the Figure.}
    \label{fig:quadtree2}
\end{figure}
