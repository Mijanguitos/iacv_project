...
\subsubsection{3D Trajectory Reconstruction}
...
The final output of this stage is the trajectory of the ball expressed in the 3D coordinate system of the lane. The resulting representation is consistent with both the geometric constraints of the lane and the physical dimensions of the ball \cite{dimensionscom2024balldimensions}.
