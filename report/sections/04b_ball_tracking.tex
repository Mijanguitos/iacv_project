...
While the matrix $R$ fully describes the orientation change, it is not directly interpretable in terms of physical kinematics. Therefore, we convert $R$ into an axis-angle representation. The angular velocity (the magnitude of rotation per frame), $\theta$, is derived from the trace of the rotation matrix:
\begin{equation}
