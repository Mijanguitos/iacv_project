...
This normalized 3D vector represents the instantaneous axis of rotation in the camera's coordinate system. Physically, the $X$ component corresponds to the horizontal axis (forward roll or backspin), the $Y$ component corresponds to the vertical axis (side-spin, rotating like a top), and the $Z$ component represents depth roll (rotating around the viewing axis). In bowling terminology, the specific combination of these components mathematically characterizes the bowler's \emph{axis tilt} and \emph{axis rotation}, which ultimately dictate how the ball will hook as it travels down the lane.
