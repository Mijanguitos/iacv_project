...
\begin{figure}[htbp]
    ...
    \caption{Three-dimensional spatial reconstruction of the lane and ball trajectory. Top: The primary homographic mapping into physical coordinate space. Middle: A sequential shift in viewing perspective, accompanied by the spatial legend defining the origin, axes, and trajectory path. Bottom: A final perspective shift further highlighting the lateral curvature of the trajectory.}
    \label{fig:3d_reconstruction_complete}
\end{figure}